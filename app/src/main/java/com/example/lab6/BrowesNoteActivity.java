...
public class BrowesNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showNote = findViewById(R.id.textView10);
        showNoteFromAPI = findViewById(R.id.textView9);
        ...
        text=findViewById(R.id.editTextText3);
        progressBar2=findViewById(R.id.progressBar2);
        progressBar2.setVisibility(View.GONE);
        display2=findViewById(R.id.textView);
        addSearch = findViewById(R.id.button2);
